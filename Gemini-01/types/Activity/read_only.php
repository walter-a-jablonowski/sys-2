...
<div class="card">
  <div class="card-header d-flex justify-content-between align-items-center">
    ...
    <span class="badge bg-secondary"><?= htmlspecialchars($entry_data['type']) ?></span>
  </div>
  <div class="card-body">
    <p class="card-text"><?= nl2br(htmlspecialchars($entry_data['description'])) ?></p>
    <hr>
    <ul class="list-group list-group-flush">
      <li class="list-group-item"><strong>Priority:</strong> <?= htmlspecialchars($entry_data['data']['priority'] ?? 'N/A') ?></li>
      <li class="list-group-item"><strong>State:</strong> <?= htmlspecialchars($entry_data['data']['state'] ?? 'N/A') ?></li>
      <li class="list-group-item"><strong>Due Date:</strong> <?= htmlspecialchars($entry_data['data']['dueDate'] ?? 'N/A') ?></li>
    </ul>
  </div>
</div>
